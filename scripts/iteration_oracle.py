"""ARCHIVED PRE-DESIGN PROBE — do not run as a campaign prerequisite.

This fixed-two-hop oracle study predates and is superseded by the production
Planner-variable MA-RAG executor in ``src/pipeline.py``.  It remains only as
historical design provenance.

Oracle ceiling for iterative retrieval. CPU only.
