...
This script preserves an early fixed-two-pass ceiling study.  Its assumptions,
cohorts, and 7/3 budget were superseded by the Planner-variable MA-RAG loop in
``src/pipeline.py``.  Do not use its output in the final paper or campaign gate.
